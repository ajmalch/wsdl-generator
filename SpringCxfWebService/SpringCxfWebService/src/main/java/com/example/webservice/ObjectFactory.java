...
public class ObjectFactory {
    ...
    private final static QName _GetUserDetails_QNAME = new QName("http://webservice.example.com/", "getUserDetails");
    private final static QName _AddUserDetails_QNAME = new QName("http://webservice.example.com/", "addUserDetails");
    private final static QName _GetUserDetailsResponse_QNAME = new QName("http://webservice.example.com/", "getUserDetailsResponse");
    private final static QName _AddUserDetailsResponse_QNAME = new QName("http://webservice.example.com/", "addUserDetailsResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.example.com/", name = "getUserDetails")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.example.com/", name = "addUserDetails")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.example.com/", name = "getUserDetailsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.example.com/", name = "addUserDetailsResponse")
